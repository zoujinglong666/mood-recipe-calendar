  ...
  <view class="report">
    ...
    <swiper v-else class="report__swiper" vertical :current="currentPage" @change="onSwiperChange" :duration="320">
      ...
      <view class="rpt-cover rpt-page">
        ...
        <image class="rpt-cover__guozai" :src="STATIC_BASE_URL + '/static/guozai/action_06_glasses.png'" mode="aspectFit" />
      ...
      <view class="rpt-overview rpt-page">
        ...
        <image class="rpt-guozai" :src="STATIC_BASE_URL + '/static/guozai/mood_10_content.png'" mode="aspectFit" />
      ...
      <view class="rpt-top3 rpt-page">
        ...
        <image class="rpt-guozai rpt-guozai--sm" :src="STATIC_BASE_URL + '/static/guozai/mood_11_proud.png'" mode="aspectFit" />
      </view>
      </swiper-item>
      ...
      <view class="rpt-mood rpt-page">
        ...
        <image class="rpt-guozai rpt-guozai--sm" :src="STATIC_BASE_URL + '/static/guozai/mood_01_happy.png'" mode="aspectFit" />
      </view>
      </swiper-item>
      ...
      <view class="rpt-best rpt-page">
        ...
        <image class="rpt-guozai rpt-guozai--sm" :src="STATIC_BASE_URL + '/static/guozai/mood_10_content.png'" mode="aspectFit" />
      </view>
      </swiper-item>
      ...
      <view class="rpt-message rpt-page">
        <view class="rpt-message__guozai-wrap">
          <image class="rpt-message__guozai" :src="STATIC_BASE_URL + '/static/guozai/action_06_glasses.png'" mode="aspectFit" />
      ...
      <view class="rpt-share rpt-page">
        <view class="rpt-share__header">
          ...
          <image class="rpt-share__guozai-sm" :src="STATIC_BASE_URL + '/static/guozai/action_09_celebrate.png'" mode="aspectFit" />
        </view>

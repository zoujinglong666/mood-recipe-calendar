...
public class WeeklyMealPlanController {
    ...
    public WeeklyMealPlanController(WeeklyMealPlanService plans, GuozaiAgent agent, DialogueAgent mealAgent) { this.plans = plans; this.agent = agent; this.mealAgent = mealAgent; }
